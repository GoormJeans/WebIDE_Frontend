...
const AdminNav = () => {
  ...
  return (
    <div className="w-full h-full">
      <div className="w-auto h-full flex flex-row items-center bg-transparent mx-5 pl-5 whitespace-nowrap">
        ...
        <button className="h-[60px] items-center justify-between whitespace-nowrap hover:cursor-pointer text-white mr-5" onClick={()=>navigate('algorithm')}>Problems</button>
      </div>
    </div>
  )
}
