...
import AdminAlgoProbs from "./AdminAlgoProbs"



const AlgoList: React.FC<{ probs: AdminAlgo[]; }> = ({ probs }) => {
      ...
      <div className="w-full h-full ">
        ...
        <div className="w-auto h-full flex flex-col justify-between items-center m-5 rounded-xl px-5 pt-5 border-2 whitespace-nowrap">
          {probs && Array.isArray(probs) &&
            probs.map((element) => <AdminAlgoProbs prob={element} key={element.algorithmId} />)
          }
