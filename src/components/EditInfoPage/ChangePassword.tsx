...
export const ChangePassword = () => {
  ...
  return (
    <div className='mx-5 my-5 px-5 py-5 rounded-3xl bg-nav-color shadow-xl'>
      <span className="font-k2d text-3xl">Change Password</span>
      ...
      {!isPasswordValid && user.passwordValue && <p className="flex font-k2d text-rose-500 justify-center">Invalid password format</p>}
      <InfoEditInputTag inputType={{
        type: 'password',
        placeholder: 'Confirm Password',
        label: 'password again'
      }} value={user.confirmPasswordValue} onChange={handleConfirmPasswordChange} isErrored={!isConfirmPasswordValid} />
      {!isConfirmPasswordValid && user.confirmPasswordValue && <p className="flex font-k2d text-rose-500 justify-center">Passwords do not match</p>}
